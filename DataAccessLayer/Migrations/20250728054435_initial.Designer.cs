...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250728054435_initial")]
            ...
            modelBuilder.Entity("EntityLayer.JobPosting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 7, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9521),
                            ...
                            ExpiryDate = new DateTime(2025, 8, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9522),
                            IsActive = true,
                            IsFilled = false,
                            IsRemote = true,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 7, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9534),
                            Description = "E-ticaret projelerimizde görev alacak, modern frontend teknolojilerine hakim React Developer arıyoruz.",
                            EmploymentType = "Tam Zamanlı",
                            ExpiryDate = new DateTime(2025, 8, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9534),
                            IsActive = true,
                            IsFilled = false,
                            IsRemote = true,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 7, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9538),
                            Description = "Bulut altyapımızı yönetecek ve geliştirme süreçlerimizi iyileştirecek DevOps Mühendisi arıyoruz.",
                            EmploymentType = "Tam Zamanlı",
                            ExpiryDate = new DateTime(2025, 8, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9538),
                            IsActive = true,
                            IsFilled = false,
                            IsRemote = true,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 7, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9541),
                            Description = "Yapay zeka projelerimizde görev alacak, Python ve ML konularında deneyimli geliştirici arıyoruz.",
                            EmploymentType = "Tam Zamanlı",
                            ExpiryDate = new DateTime(2025, 8, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9542),
                            IsActive = true,
                            IsFilled = false,
                            IsRemote = true,
                            Location = "İstanbul, Türkiye",
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 7, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9545),
                            Description = "Cross-platform mobil uygulama geliştirme konusunda deneyimli Flutter Developer arıyoruz.",
                            EmploymentType = "Tam Zamanlı",
                            ExpiryDate = new DateTime(2025, 8, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9545),
                            IsActive = true,
                            IsFilled = false,
                            IsRemote = true,
            ...
            modelBuilder.Entity("EntityLayer.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 7, 28, 8, 44, 34, 845, DateTimeKind.Local).AddTicks(9325),
